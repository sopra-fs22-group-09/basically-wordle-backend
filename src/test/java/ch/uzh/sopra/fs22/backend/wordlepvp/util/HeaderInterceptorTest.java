...
@Component
public class HeaderInterceptorTest implements WebSocketGraphQlInterceptor {

    private final Logger log = LoggerFactory.getLogger(HeaderInterceptorTest.class);

    private final UserService userService;

    public HeaderInterceptorTest(UserService userService) {
    ...
    public Mono<WebGraphQlResponse> intercept(WebGraphQlRequest request, Chain chain) {
        ...
        String authHeader = "Bearer Toast";
        log.debug("Set Authorization header: {}", authHeader);

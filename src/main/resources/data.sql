--All users
insert into users (id, created_at, updated_at, activated, avatarid, email, password_hash, reset_token, settings, status, tutorial_completed, username) values ('6eec88ff-e643-4617-9d77-10cba6044050', '2022-05-13 13:13:12.999998', null, true, null, 'mete@localhost', '$argon2id$v=19$m=4096,t=3,p=1$TTA7TLbieWng6w+igRYxyQ$rZT5h+Pu2qARIEjoJUB9ErNiv9zTnBcVcUn4l9Du1kg', null, null, 0, true, 'Mete');
insert into users (id, created_at, updated_at, activated, avatarid, email, password_hash, reset_token, settings, status, tutorial_completed, username) values ('44cc3f8c-436b-47d8-896b-7563d60355b4', '2022-05-13 13:13:12.999999', null, true, null, 'elvio@localhost', '$argon2id$v=19$m=4096,t=3,p=1$TTA7TLbieWng6w+igRYxyQ$rZT5h+Pu2qARIEjoJUB9ErNiv9zTnBcVcUn4l9Du1kg', null, null, 0, true, 'Elvio');
insert into users (id, created_at, updated_at, activated, avatarid, email, password_hash, reset_token, settings, status, tutorial_completed, username) values ('c252e500-5d64-4ca6-86cf-e9c7483a2356', '2022-05-13 13:13:14.000001', null, true, null, 'jerome@localhost', '$argon2id$v=19$m=4096,t=3,p=1$TTA7TLbieWng6w+igRYxyQ$rZT5h+Pu2qARIEjoJUB9ErNiv9zTnBcVcUn4l9Du1kg', null, null, 0, true, 'Jerome');
insert into users (id, created_at, updated_at, activated, avatarid, email, password_hash, reset_token, settings, status, tutorial_completed, username) values ('f1961be8-fb94-4431-8262-eef1f71257fe', '2022-05-13 13:13:14.000002', null, true, null, 'matej@localhost', '$argon2id$v=19$m=4096,t=3,p=1$TTA7TLbieWng6w+igRYxyQ$rZT5h+Pu2qARIEjoJUB9ErNiv9zTnBcVcUn4l9Du1kg', null, null, 0, true, 'Matej');
insert into users (id, created_at, updated_at, activated, avatarid, email, password_hash, reset_token, settings, status, tutorial_completed, username) values ('e51fdd83-640e-4ba6-a953-bb8812e8abf8', '2022-05-13 13:13:14.000003', null, true, null, 'matthias@localhost', '$argon2id$v=19$m=4096,t=3,p=1$TTA7TLbieWng6w+igRYxyQ$rZT5h+Pu2qARIEjoJUB9ErNiv9zTnBcVcUn4l9Du1kg', null, null, 0, true, 'Matthias');
insert into users (id, created_at, updated_at, activated, avatarid, email, password_hash, reset_token, settings, status, tutorial_completed, username) values ('eebe92fa-d468-4f2d-85b5-014f7de962b5', '2022-05-13 13:13:14.000003', null, true, null, 'raffael@localhost', '$argon2id$v=19$m=4096,t=3,p=1$TTA7TLbieWng6w+igRYxyQ$rZT5h+Pu2qARIEjoJUB9ErNiv9zTnBcVcUn4l9Du1kg', null, null, 0, true, 'Raffael');
